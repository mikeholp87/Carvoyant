...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    map.vehicleName = [[vehicles objectForKey:[NSString stringWithFormat:@"%d",indexPath.row]] objectForKey:@"name"];
    
    NSDictionary *lastWaypoint = [[vehicles objectForKey:[NSString stringWithFormat:@"%d",indexPath.row]] objectForKey:@"lastWaypoint"];
    
    if(![lastWaypoint isKindOfClass:[NSNull class]]){
        ...
        map.latitude = @"28.1793926";
        map.longitude = @"-82.5579537";
    }
